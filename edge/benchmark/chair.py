"""CHAIR benchmark for open-ended image captioning hallucination evaluation."""

import os
import json
import pickle
import numpy as np
from edge.benchmark.evaluators import chair_evaluator


class ChairBenchmarkDataset:
    def __init__(self, coco_path: str, coco_file: str, base_image_path: str, chair_test_size: int):

...
# =============================================================================
# CHAIR protocol supplement runs on GPU 3
# Covers:
#   - crops / sampling / seed 44
#   - entropygate / sampling / seed 44
# =============================================================================
...
LOG_FILE="${LOG_DIR}/chair_protocol_gpu3_${RUN_TAG}.log"

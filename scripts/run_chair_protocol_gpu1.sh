...
# =============================================================================
# CHAIR protocol supplement runs on GPU 1
# Covers:
#   - entropygate / sampling / seed 42
#   - vanilla / sampling / seed 44
# =============================================================================
...
LOG_FILE="${LOG_DIR}/chair_protocol_gpu1_${RUN_TAG}.log"

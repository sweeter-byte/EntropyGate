...
# =============================================================================
# CHAIR protocol supplement runs on GPU 2
# Covers:
#   - crops / sampling / seed 43
#   - entropygate / sampling / seed 43
# =============================================================================
...
LOG_FILE="${LOG_DIR}/chair_protocol_gpu2_${RUN_TAG}.log"

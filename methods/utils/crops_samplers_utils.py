def get_generations(self,
    ...
    # Always pass output_attentions explicitly — True for passes that need
    # attention masks (fast_v / text_mask), False otherwise to save memory.
    ...
    # Compatible with multiple transformers API versions for _update_model_kwargs_for_generation
    try:
